        ...
        <div className="row col-12">
          <BrowserRouter>
            ...
            <div className="col-6">
              ...
              <Route
                exact={true}
                path="/user/getcontractor"
                component={ShowContractors}
              />
              <Route
                exact={true}
                path="/user/getlabour"
                component={ShowLabours}
              />
              <Route
                exact={true}
                path="/user/getallassigned"
                component={AssignedWork}
              />
              <Route
                exact={true}
                path="/user/getaddedworks"
                component={WorkList}
              />
              <Route
                exact={true}
                path="/user/showbidding"
                component={ShowBidding}
              />
              <Route exact={true} path="/user/addReview" component={Reviwe} />
              <Route
                exact={true}
                path="/user/upadateuser"
                component={UpdateUser}
              />
              <Route
                exact={true}
                path="/user/ShowReview"
