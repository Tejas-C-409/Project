...
function Labourpage() {
  ...
  useEffect(() => {
    ...
    axios.get(`${baseurl}/user/getLabourByUSerId/${l}`).then(
      (response) => {
    ...
    <div>
      <div>
        <div className="row col-12 UpperBar bg bg-warning">
          ...
          <div className="col-3">
            <h5>Profession: {role}</h5>
          </div>
          <div className="col-3 username">
            <h5>Hello {name}</h5>
          </div>
          <div className="col-3">
            <Button color="info" className="m-1" inverse onClick={refresh}>
              Refresh
            </Button>
            <Button color="danger" inverse onClick={Logout}>
              Logout
            </Button>
          </div>
        </div>
          ...
          <div className="row col-12">
            <BrowserRouter>
              ...
              <div className="col-6">
                <Route
                  exact={true}
                  path="/labour/showAvialableWorks"
                  component={LShowAvailableWork}
                />
                <Route
                  exact={true}
                  path="/labour/addbidding"
                  component={LAddBidding}
                />
                <Route
                  exact={true}
                  path="/labour/showBidding"
                  component={LShowBidding}
                />
                <Route
                  exact={true}
                  path="/labour/updateprof"
                  component={LUpdateLabour}
                />
                <Route
                  exact={true}
                  path="/labour/showAssignedForContractor"
                  component={LAssignedWorkListForContractor}
                />
                <Route
                  exact={true}
                  path="/labour/showAssignedForLabour"
                  component={LAssignedWorkListForContractorass}
                />
                <Route
                  exact={true}
                  path="/labour/requestForm"
                  component={RequestForm}
                />
                <Route
                  exact={true}
                  path="/labour/ShowContractorByPin"
                  component={ShowContractorsbypinl}
                />
                <Route
                  exact={true}
                  path="/labour/ShowContractorprof"
                  component={ShowContractorsprof}
                />
                <Route
                  exact={true}
                  path="/labour/ShowMyReview"
                  component={ShowCReview}
                />
