...
function Contractorpage() {
  ...
  useEffect(() => {
    if (
      ...
      sessionStorage.getItem("logCdata") === null
    ) {
      history1.replace("/");
    } else {
  ...
  return (
    <div className="">
      <div
        className="row col-12 UpperBar bg-warning p-1 "
        ...
        <div className="row col-12">
          <BrowserRouter>
            ...
            <div className="col-6">
              <Route
                exact={true}
                path="/contractor/addLicenseNo"
                component={LicensnoForm}
              />
              <Route
                exact={true}
                path="/contractor/ShowRecentWork"
                component={ShowAvailableWork}
              />
              <Route
                exact={true}
                path="/contractor/addBidding"
                component={AddBidding}
              />
              <Route
                exact={true}
                path="/contractor/showBidding"
                component={ShowBidding}
              />
              <Route
                exact={true}
                path="/contractor/ShowBiddingByCOntractorID"
                component={ShowBiddingByCOntractorID}
              />
              <Route
                exact={true}
                path="/contractor/AssignedWorkByCOntractorID"
                component={AssignedWorkListForContractor}
              />
              <Route
                exact={true}
                path="/contractor/GetLabourListByContractorID"
                component={ShowLaboursListForContractor}
              />
              <Route
                exact={true}
                path="/contractor/updateLabour"
                component={UpdateCLabour}
              />
              <Route
                exact={true}
                path="/contractor/requestList"
                component={ShowRequestList}
              />
              <Route
                exact={true}
                path="/contractor/ShowReviews"
